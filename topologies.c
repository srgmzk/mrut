...
insert_link_between_two_nodes(R0_re, R3_re, "eth0/6", "eth0/7", 1);

insert_link_between_two_nodes(R0_re, R2_re, "eth0/4", "eth0/5", 1);
insert_link_between_two_nodes(R2_re, R1_re, "eth0/3", "eth0/2", 1);
...
build_simple_l2_switch_topo() {
        ...
        |                         |eth0/3                    |
        |                         |                          |
        |10.1.1.2/24              |10.1.1.4/24               |10.1.1.1/24
		|0/5                      |0/8                       |0/6
   +----+----+              +-----+-----+              +-----+----+
   |         |              |           |              |          |
   |   H1    |              |    H2     |              |    H3    |
